...
radio_analysis4_table |> saveRDS("results/radio_analysis4_table.RDS")
...
p <- p + theme_bw() +
  ...
  icbp_colour_manual()
p 
ggsave("results/radio_time2_differences.png",
       plot = p,
       width = 15,
       height = 11.25,
       units = "cm")
